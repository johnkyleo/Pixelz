...
const CartItems = () => {
  ...
  return (
    <section className='max_padd_container pt-28 w-screen'>
        <table className='w-full mx-auto'>
           <thead>
                <tr className='bgslate-900/10 regular-18 sm:regular-22 text-start py-12'>
        ...
        <div className='flexCenter flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white max-w-[450px]'>
            <div className='flex flex-col gap-10'>
                <h4 className='bold-20'>Summary</h4>
                <div>
                    <div className='flexBetween py-4'>
                        <h4 className='medium-16'>Subtotal:</h4>
                        <h4 className='text-gray-50 font-semibold'>${getTotalAmount()}</h4>                                   
                    </div>
                    <hr />
                    <div className='flexBetween py-4'>
