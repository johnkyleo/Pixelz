...
const Navbar = ({containerStyles}) => {
  return (
    <nav className={`${containerStyles}`}>
        ...
        <NavLink to={'/phone'} className={({isActive}) => isActive ? "active_link" : ""}><div className="flexCenter gap-x-1"> <IoPhonePortraitOutline />  Phone</div> </NavLink>
        <NavLink to={'/laptop'} className={({isActive}) => isActive ? "active_link" : ""}><div className="flexCenter gap-x-1"> <IoLaptopOutline />Laptop</div> </NavLink>
