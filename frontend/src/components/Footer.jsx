   ...
   <footer className="flexCenter pb-24 pt-20">
    <div className="max_padd_container flex w-full flex-col gap-14">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          <Link to='/' className="mb-10 bold-20 "><img src={logo} alt="" height={111} width={111}/></Link>
              ...
              <FooterColumn >
                <ul className="flex gap-4">
                    {SOCIALS.links.map((link) => (
                      <Link to='/' key={link}>
                        <img src={link} alt="socialIcon" width={22} height={22}/>
                      </Link>
                    ))}
                </ul>
              </FooterColumn>
          ...
          <p className="text-center">2024 PIXELZ | All rights reserve.</p>
